...
<template>
    ...
    >
      <ReplyMessage />
		...
		<div class="h-auto min-h-[84px] p-5 flex items-end" :class="recording ? ['justify-between'] : []">
			...
			<div class="grow md:mr-5 xs:mr-4 self-end" v-if="!recording">
				<div class="relative">
					<TextArea v-model="form.text" @input="handleSetDraft" :value="form.text"
					...
					<div class="absolute bottom-[13px] right-0">
						<!--emoji button-->
						<IconButton title="toggle emoji picker" aria-label="toggle emoji picker"
			...
			<div class="min-h-[44px] flex">
				...
				<IconButton v-if="!recording"
					...
					variant="ghost" title="send message" aria-label="send message" @click="handleSendMessage">
